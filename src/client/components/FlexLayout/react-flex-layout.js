...
import LayoutSplitter from './react-flex-layout-splitter.js'
import layoutEvents from './react-flex-layout-events.js'
...
export default class Layout extends React.Component {
  ...
  handleResize(fromWindow = false) {

    let newWidth = this.state.layoutWidth
    let newHeight = this.state.layoutHeight

    if (this.props.fill === 'parent' || fromWindow) {

      newWidth = this.props.layoutWidth
      newHeight = this.props.layoutHeight
